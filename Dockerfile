...
COPY sdxl-base-10000-000009.safetensors /stable-diffusion-webui/models/Lora/sdxl-base-10000-000009.safetensors
COPY sd_xl_base_1.0.safetensors /stable-diffusion-webui/models/Stable-diffusion/sd_xl_base_1.0.safetensors
...
# RUN cd /stable-diffusion-webui && python cache.py --use-cpu=all --ckpt /stable-diffusion-webui/models/Lora/sdxl-base-10000-000009.safetensors && python cache.py --use-cpu=all --ckpt /stable-diffusion-webui/models/Lora/model2.safetensors
RUN cd /stable-diffusion-webui && python cache.py --use-cpu=all --ckpt /stable-diffusion-webui/models/Stable-diffusion/sd_xl_base_1.0.safetensors
